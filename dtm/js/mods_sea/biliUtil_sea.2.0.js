...
if (typeof define === "function" && define.cmd) {
    // 加载登录状态
    seajs.use('http://static.biligame.net/mods_sea/biliLoginStatus_sea');

    // 埋点
    seajs.use('http://data.bilibili.com/rec');

    define(['http://static.hdslb.com/js/jquery.min', 'http://static.biligame.net/lib/js-cookie/2.1.1/js.cookie.min.js'], function(require, exports){
